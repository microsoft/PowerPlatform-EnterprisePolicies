...
title: Remove-PPRBACRoleAssignment
---
...
```
Remove-PPRBACRoleAssignment -RoleAssignmentId <string> -TenantId <string> [-ClientId <string>]
...
```
Remove-PPRBACRoleAssignment -RoleAssignmentId <string> -TenantId <string> -EnvironmentId <string>
...
```
Remove-PPRBACRoleAssignment -RoleAssignmentId <string> -TenantId <string>
 -EnvironmentGroupId <string> [-ClientId <string>] [-Endpoint <PPEndpoint>] [-ForceAuth] [-Force]
