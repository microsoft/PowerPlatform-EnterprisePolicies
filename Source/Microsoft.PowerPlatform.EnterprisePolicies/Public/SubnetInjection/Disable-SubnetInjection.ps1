...
function Disable-SubnetInjection {
    ...
    if ($null -eq $environment) {
        throw "Failed to retrieve environment with ID: $EnvironmentId. If the environment exists, ensure you have the necessary permissions to access it and that you are connecting to the correct Power Platform endpoint."
    }
