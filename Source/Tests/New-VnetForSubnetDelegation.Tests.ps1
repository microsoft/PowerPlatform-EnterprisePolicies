...
Describe 'New-VnetForSubnetDelegation Tests' {
    BeforeAll {
        ...
        Mock Set-AzContext { return @{Subscription = "test-subscription"} } -ModuleName "Microsoft.PowerPlatform.EnterprisePolicies"
    ...
    Context 'Testing existing VNet configuration' {
        ...
        It 'Should authenticate with TenantId when provided' {
            Mock Connect-Azure { return $true } -ParameterFilter { $TenantId -eq "87654321-4321-4321-4321-210987654321" } -ModuleName "Microsoft.PowerPlatform.EnterprisePolicies"

            $result = New-VnetForSubnetDelegation -SubscriptionId "12345678-1234-1234-1234-123456789012" -VirtualNetworkName "test-vnet" -SubnetName "default" -ResourceGroupName "test-rg" -TenantId "87654321-4321-4321-4321-210987654321"

            Should -Invoke Connect-Azure -Times 1 -ParameterFilter { $TenantId -eq "87654321-4321-4321-4321-210987654321" } -ModuleName "Microsoft.PowerPlatform.EnterprisePolicies"
        }
