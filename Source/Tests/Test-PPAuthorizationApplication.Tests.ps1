...
Describe 'Test-PPAuthorizationApplication Tests' {
    BeforeAll {
    ...
    Context 'Valid application configuration' {
        ...
        It 'Should return true for correctly configured application' {
            $result = Test-PPAuthorizationApplication -ClientId $script:testAppId -TenantId $script:testTenantId

            $result | Should -Be $true
        }

        It 'Should use prod API ID for prod endpoint' {
            Test-PPAuthorizationApplication -ClientId $script:testAppId -TenantId $script:testTenantId -Endpoint prod
    ...
    Context 'TIP endpoint validation' {
        ...
        It 'Should use TIP API ID for tip1 endpoint' {
            Test-PPAuthorizationApplication -ClientId $script:testAppId -TenantId $script:testTenantId -Endpoint tip1
