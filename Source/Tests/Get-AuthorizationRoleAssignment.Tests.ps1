...
Describe 'Get-AuthorizationRoleAssignment Tests' {
    BeforeAll {
    ...
    Context 'Tenant-scoped role assignments' {
        ...
        It 'Should get tenant-scoped role assignments' {
            $result = Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId

            $result | Should -Not -BeNullOrEmpty
        }

        It 'Should call New-AuthorizationServiceMsalClient' {
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId
    ...
    Context 'Environment-scoped role assignments' {
        ...
        It 'Should get environment-scoped role assignments' {
            $result = Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -EnvironmentId $script:testEnvironmentId

            $result | Should -Not -BeNullOrEmpty
        }

        It 'Should pass EnvironmentId to Get-RoleAssignments' {
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -EnvironmentId $script:testEnvironmentId
    ...
    Context 'Optional parameters' {
        ...
        It 'Should pass IncludeParentScopes when specified' {
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -IncludeParentScopes
        ...
        It 'Should pass ExpandSecurityGroups when specified' {
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -ExpandSecurityGroups
        ...
        It 'Should pass ExpandEnvironmentGroups when specified' {
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -ExpandEnvironmentGroups
        ...
        It 'Should pass IncludeNestedScopes when specified' {
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -IncludeNestedScopes
        ...
        It 'Should pass PrincipalType when specified' {
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -PrincipalType User
        ...
        It 'Should pass PrincipalObjectId when specified' {
            ...
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -PrincipalObjectId $testPrincipalId
        ...
        It 'Should pass Permission when specified' {
            Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId -Permission "Read"
    ...
    Context 'Error handling' {
        It 'Should throw when New-AuthorizationServiceMsalClient fails' {
            ...
            { Get-AuthorizationRoleAssignment -ClientId $script:testClientId -TenantId $script:testTenantId } | Should -Throw "*Failed to connect to Authorization Service*"
        }
    }
}
