...
Write-Warning "This script is deprecated. Please use the Enable-SubnetInjection cmdlet from the Microsoft.PowerPlatform.EnterprisePolicies module instead."
