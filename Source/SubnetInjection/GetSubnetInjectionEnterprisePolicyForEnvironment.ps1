...
{
    Write-Warning "DEPRECATED: This script is deprecated. Use 'Get-SubnetInjectionEnterprisePolicy -EnvironmentId' from the Microsoft.PowerPlatform.EnterprisePolicies module instead."
