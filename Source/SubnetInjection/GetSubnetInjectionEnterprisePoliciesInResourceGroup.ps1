...
{
    Write-Warning "DEPRECATED: This script is deprecated. Use 'Get-SubnetInjectionEnterprisePolicy -SubscriptionId -ResourceGroupName' from the Microsoft.PowerPlatform.EnterprisePolicies module instead."
